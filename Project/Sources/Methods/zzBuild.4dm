...
*/
var $appleUserID; $bundleID; $message; $target; $UUID : Text
var $finished : Boolean
var $progress : Integer
var $error : Object
var $builder : cs:C1710.Build

$appleUserID:="vdl"+Char:C90(64)+"mac.com"  // I don't like my email on github in clear text
$bundleID:="lib4darm64"
...
If ($error.success=True:C214)
	...
	Else 
		...
		While ((Not:C34($finished))\
			 & (Not:C34(Process aborted:C672)))
